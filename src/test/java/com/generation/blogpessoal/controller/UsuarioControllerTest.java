...
public class UsuarioControllerTest {
	...
	public void deveListarApenasUsuario() {
		Optional<Usuario> usuarioBusca = usuarioService.cadastrarUsuario(new Usuario(0L, "Laura Santolia", "laura_santolia@email.com.br", "laura12345", "https://i.imgur.com/Sk5SjWE.jpg"));
	...
	public void deveAutenticarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Rebecca Cruz",
				"rebecca@email.com.br", "rebecca123", "https://i.imgur.com/2yDRVeK7.jpg"));

		HttpEntity<UsuarioLogin> corpoRequisicao = new HttpEntity<UsuarioLogin>(new UsuarioLogin(0L,"",
				"rebecca@email.com.br", "rebecca123", ""));

		ResponseEntity<UsuarioLogin> corpoResposta = testRestTemplate
				.exchange("/usuarios/login", HttpMethod.POST, corpoRequisicao, UsuarioLogin.class);
